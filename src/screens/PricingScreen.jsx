...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: "WhatsApp ו-SMS אוטומטיים", included: false },
      { text: "סנכרון ענן", included: false },
    ],
    cta: "התחל חינם",
    ctaTo: "/signup",
    highlight: false,
  },
  {
    ...
    features: [
      ...
      { text: "WhatsApp ו-SMS אוטומטיים", included: true },
      { text: "סנכרון ענן", included: true },
    ],
    cta: "שדרג עכשיו",
    ctaTo: "/signup",
    highlight: true,
...
const FAQ = [
  ...
  {
    q: "איך עובדים WhatsApp ו-SMS?",
    a: "המערכת שולחת הודעות אוטומטיות לאורחים עם אישור הגעה, תזכורת לפני האירוע, ומספר שולחן ביום האירוע — דרך WhatsApp Business API או SMS.",
  },
  {
