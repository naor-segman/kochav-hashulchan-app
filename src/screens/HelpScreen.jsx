...
const FAQ = [
  ...
  },
  {
    ...
    a: "בטאב \"הושבה\" לוחצים \"חשבו הושבה\". המערכת משבצת את כל האורחים תוך כיבוד קבוצות, צדדים ואילוצים (מי יושב עם מי ומי בנפרד). אפשר לגרור אורחים בין שולחנות לפי הצורך — כל שינוי נשמר מיד.",
  },
  {
