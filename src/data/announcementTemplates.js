...
const HE = {
  ...
  // A brit is announced days ahead, not months — "שמרו את התאריך" would be
  // absurd on it, so both lines say the thing that is actually true.
  "ברית":         { a: "נולד לנו בן!",   b: "מוזמנים לברית" },
  "בריתה":        { a: "נולדה לנו בת!",  b: "מוזמנים לבריתה" },
...
const INVITE_HE = {
  ...
  "ברית":         "אתם מוזמנים לברית",
  "בריתה":        "אתם מוזמנים לבריתה",
