...
const SCREENS = [
  ...
  ['svc-seating', '/services/seating'], ['svc-site', '/services/event-site'], ['svc-plan', '/services/planning'], ['svc-rsvp', '/services/rsvp'], ['svc-day', '/services/event-day'], ['svc-gifts', '/services/gifts'],
];
